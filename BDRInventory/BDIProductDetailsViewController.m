...
- (void)viewDidLoad {
    ...
    if (product){
        ...
        self.price.text = [NSString stringWithFormat:@"%@",[currencyFormatter stringFromNumber:product.price]];
        self.quantity.text = [numberFormatter stringFromNumber:[NSNumber numberWithInteger:product.quantity]];
